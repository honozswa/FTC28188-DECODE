...
public class PoseConstant {
    ...
    public static final Pose BlueCloseAutoStartPose = new Pose(19, 119, Math.toRadians(141));
    ...
    public static final Pose BlueFarResetPose = new Pose(135,8,Math.toRadians(180));
    ...
    public static final Pose RedCloseAutoStartPose = new Pose(125, 119, Math.toRadians(39));
    ...
    public static final Pose RedFarResetPose = new Pose(9,8,Math.toRadians(0));
