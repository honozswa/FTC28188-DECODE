...
//            }
    ...
    public void goToGatePose() {
        PathChain shootPath = follower.pathBuilder()
                .addPath(new BezierLine(
                        follower.getPose(),
                        PoseConstant.RedGate
                ))
                .setLinearHeadingInterpolation(follower.getPose().getHeading(), PoseConstant.RedGate.getHeading())
                .build();
    ...
    public void resetPose() {
        follower.setPose(PoseConstant.RedResetPose);
    }

    public void resetFarPose() {
        follower.setPose(PoseConstant.RedFarResetPose);
    }
